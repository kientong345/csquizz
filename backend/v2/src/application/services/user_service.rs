...
use crate::{
    ...
    interface::dto::user_dto::{UpdateUserProfileDto, UpdateUserRoleDto, ListUsersQuery},
};
...
impl UserService {
    ...
    pub async fn update_user_profile(&self, user_id: i32, dto: UpdateUserProfileDto) -> ServiceResult<()> {
    ...
    pub async fn update_user_role(&self, user_id: i32, dto: UpdateUserRoleDto) -> ServiceResult<()> {
