...
CREATE TABLE IF NOT EXISTS comment_likes (
    cmtlk_user_id       INT REFERENCES users(usr_id) ON DELETE CASCADE,
    cmtlk_comment_id    INT REFERENCES comments(cmt_id) ON DELETE CASCADE,
	
	CONSTRAINT unique_comment_like UNIQUE(cmtlk_user_id, cmtlk_comment_id) DEFERRABLE INITIALLY IMMEDIATE
);
